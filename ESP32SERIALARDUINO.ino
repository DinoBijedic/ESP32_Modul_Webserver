      ...
      if (client.available()) {  // if there's bytes to read from the client,
        ...
        if (c == '\n') {  // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            //Forsøg på at automatisere opdatering af A1 value på siden
            ...
            //Funktionel kode som kan indkommenteres for at få A1 til at blive vist via knap tryk
            //Udkommenter koden linje 71-79 hvis denne kode ønskes brugt
